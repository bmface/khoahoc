...
tabEl.forEach(function (e) {
  ...
  setTimeout(function () {
    document.querySelectorAll(".gridjs-checkbox").forEach(function (e) {
      e.addEventListener("click", function (e) {
        e.target.closest(".gridjs-tr").classList.contains("gridjs-tr-selected")
          ? isSelected--
          : (document
              .getElementById("delete-product")
              .addEventListener("click", function () {
                e.target.closest(".gridjs-tr").remove(),
...
removeItem.addEventListener("show.bs.modal", function (e) {
  (isSelected = 0),
    document
      .getElementById("delete-product")
      .addEventListener("click", function () {
        e.relatedTarget.closest(".gridjs-tr") &&
          (e.relatedTarget.closest(".gridjs-tr").remove(),
          (document.getElementById("select-content").innerHTML = isSelected)),
          document.getElementById("btn-close").click(),
