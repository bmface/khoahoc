      ...
      r.querySelectorAll(".reply-message").forEach(function (n) {
        n.addEventListener("click", function () {
          var e = document.querySelector(".replyCard"),
            ...
            s = n.closest(".ctext-wrap").children[0].children[0].innerText,
      ...
      n.querySelectorAll(".copy-message").forEach(function (e) {
        e.addEventListener("click", function () {
          n.childNodes[1].children[1].firstElementChild.firstElementChild.getAttribute(
            ...
            (isText =
              n.childNodes[1].children[1].firstElementChild.firstElementChild
                .innerText),
...
function searchMessages() {
  for (
    var e,
      t = document.getElementById("searchMessage").value.toUpperCase(),
      s = document
        .getElementById("users-conversation")
    ...
    -1 <
    ((e = s[r].getElementsByTagName("p")[0]
