...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name) || empty($description)) {
        ...
        //insert course
        $sql = "INSERT INTO courses (name, description, thumb, virtual) VALUES (:name, :description, :thumb, :virtual)";
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= $domain ?>/admin/course/add.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="virtual" class="form-label">Số người đã học ảo</label>
                                    <input type="text" class="form-control" id="virtual" name="virtual" placeholder="Số người đã học ảo">
                                </div>
                                <div class="mb-3">
