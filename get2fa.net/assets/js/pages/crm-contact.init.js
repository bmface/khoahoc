function timeConvert(e) {
  var t = new Date(e);
  time_s = t.getHours() + ":" + t.getMinutes();
  var a = time_s.split(":"),
    e = a[0],
    t = a[1],
    a = 12 <= e ? "PM" : "AM";
  return (e = (e %= 12) || 12) + ":" + (t = t < 10 ? "0" + t : t) + a;
}
  ...
  removeBtns.forEach(function (e) {
    e.addEventListener("click", function (e) {
      e.target.closest("tr").children[1].innerText,
        ...
        contactList.get({ id: itemId }).forEach(function (e) {
...
addBtn.addEventListener("click", function (e) {
  ...
  editBtn.addEventListener("click", function (e) {
    (document.getElementById("exampleModalLabel").innerHTML = "Edit Contact"),
      contactList.get({ id: idField.value }).forEach(function (e) {
        (isid = new DOMParser().parseFromString(e._values.id, "text/html")),
          isid.body.firstElementChild.innerHTML == itemId &&
            e.values({
              id:
