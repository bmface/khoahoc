...
function assignToUsers() {
  ...
  if (0 < e.length)
    for (var a = 0, s = e.length; a < s; a++)
      t += `
                <a href="javascript: void(0);" class="avatar-group-item" data-img="${e[a].value}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Username">
                    <img src="./assets/images/users/${e[a].value}" alt="" class="rounded-circle avatar-xxs" />
                </a>
            `;
  else
    t += `
            <a href="javascript: void(0);" class="avatar-group-item" data-img="https://icon-library.com/images/no-user-image-icon/no-user-image-icon-3.jpg" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Title">
...
function deleteMultiple() {
  ids_array = [];
  for (
    var e, t = document.getElementsByName("chk_child"), a = 0;
    a < t.length;
    a++
  )
    1 == t[a].checked &&
      ((e =
        t[a].parentNode.parentNode.parentNode.querySelector(".id a").innerHTML),
      ids_array.push(e));
  if ("undefined" != typeof ids_array && 0 < ids_array.length) {
    ...
    ids_array.forEach(function (e) {
      tasksList.remove(
        "id",
        `<a href="apps-tasks-details.html" class="fw-medium link-primary">${e}</a>`
      );
    }),
