                                            ...
                                            <div class="simplebar-offset" style="right: 0px; bottom: 0px;">
                                                <div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: auto; overflow: hidden;">
                                                    <div class="simplebar-content" style="padding: 0px;">
                                                        ...
                                                        <li class="menu-title"><span data-key="t-menu">Quản Trị</span>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link menu-link <?= addActiveClass("user.php", "/admin/user/")   ?>" href="<?= $domain . "/admin/user.php" ?>">
                                                                <i class="mdi mdi-account"></i>
                                                                <span data-key="t-widgets">Tài khoản</span>
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link menu-link  <?= addActiveClass("devices.php", "/admin/devices/")   ?>" href="<?= $domain . "/admin/devices.php" ?>">
                                                        ...
                                                        <li class="nav-item ">
                                                            ...
                                                            <?= addActiveClass("course.php", "/admin/course/")   ?>" href="<?= $domain . "/admin/course.php" ?>">
                                                                <i class="mdi mdi-bookmark-box-multiple-outline"></i>
                                                                <span data-key="t-widgets">Khóa học</span>
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link menu-link <?= addActiveClass("lession.php", "/admin/lession/")   ?>" href="<?= $domain . "/admin/lession.php" ?>">
                                                                <i class="mdi mdi-book-open-page-variant-outline
"></i>
                                                                <span data-key="t-widgets">Bài học</span>
                                                            </a>
                                                        </li>
                                                        <li class="menu-title"><span data-key="t-menu">Ticket</span>
                                                        <li class="nav-item ">
                                                            <a class="nav-link menu-link 
                                                            <?= addActiveClass("tickets.php", "/admin/ticket/")   ?>" href="<?= $domain . "/admin/tickets.php" ?>">
                                                                <i class="fa-solid fa-ticket"></i>
                                                                <span data-key="t-advance-ui">Ticket</span>
                                                                <?php

                                                                $sql = "SELECT * FROM tickets WHERE (status != 'Support trả lời' AND status not like '%đóng%' )  ";
                                                                ...
                                                                if ($count > 0) {
                                                                ?>
                                                                    <span class="badge badge-pill bg-success" data-key="t-new"> <?php echo $count; ?></span>
